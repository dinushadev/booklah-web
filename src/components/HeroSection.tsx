...
const HeroSection = () => (
  <section className="py-20 px-6">
    <div className="container mx-auto text-center">
      <h2 className="text-6xl font-bold mb-8">Streamline the Appointment in Your Business</h2>
      <p className="text-3xl ">Effortless booking, happy customers, thriving business, pay as you go</p>
